...
router.get(
    ...
    async (req, res) => {
        ...
        try {
            ...
            /*
             * Les emprunts sont toujours stockés
             * dans PostgreSQL.
             */
            ...
            /*
             * Les informations des livres viennent
             * maintenant de db.json.
             */
...
router.get(
    ...
    async (_req, res) => {
        ...
        try {
            ...
            /*
             * Ajouter les informations des livres
             * provenant de db.json.
             */
            const data = result.rows.map(loan => {
        ...
        try {
            ...
            if (
                ...
                return res.status(400).json({
                    success: false,
                    message:
                        'Limite de 3 emprunts actifs atteinte.'
                });
            ...
            if (already.rowCount > 0) {
                ...
                return res.status(400).json({
                    success: false,
                    message:
                        'Vous avez déjà ce livre en emprunt.'
                });
            ...
            /*
             * Vérifier que la modification de db.json
             * a bien fonctionné.
             */
            if (!updatedBook) {
                ...
                return res.status(500).json({
                    success: false,
                    message:
                        'Impossible de mettre à jour le stock du livre.'
                });
        ...
        try {
            ...
            if (!book) {
                ...
                return res.status(404).json({
                    success: false,
                    message:
                        'Livre associé introuvable dans db.json.'
                });
